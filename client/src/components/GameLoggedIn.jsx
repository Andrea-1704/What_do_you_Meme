...
function GameLoggedIn() {
  ...
  const [timeRemaining, setTimeRemaining] = useState(30); // Aggiungi questo stato
  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(() => {
      // La funzione da eseguire dopo che il timeout è scaduto
  ...
  return (
    <div>
      <div>Time remaining: {timeRemaining} seconds</div> {/* Mostra il tempo rimanente */}
